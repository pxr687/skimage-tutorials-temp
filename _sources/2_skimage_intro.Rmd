...
Previously, we [have](0_images_as_numpy_arrays) [explored](1_colour_images_as_numpy_arrays) how images can be represented as NumPy arrays. [Scikit-image](https://scikit-image.org) (`skimage`) is a powerful image prcoessing package which is built in a large part from NumPy and SciPy, and uses NumPy arrays as its fundamental image representations. This page will show some foundational aspects of `skimage`, focusing on its coherence with the NumPy image array concepts we saw on the last two pages.
