...
the [kernel filter methods](convolution-kernel-methods).
...
*convolving* with a *kernel*.  For more on convolution, see [convolution on
Wikepedia](https://en.wikipedia.org/wiki/Convolution).
...
Let's implement a mean filter, using convolution. Obviously, we start with our
