...
The mean filter, as the name suggests, *averages* the pixel values within a kernel/neighborhood. To see this in action, let's build a simple mean filter to filter an image array. First, we perform some imports:
