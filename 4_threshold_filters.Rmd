...
`skimage`. On the [next page](5_mean_filter) we will look at convolutional
filtering, where we modify pixel values based on the "local neighborhood" of
surrounding pixels.
...
* [imindlabs on edge
  detectors](https://wiki.imindlabs.com.au/ds/aml/4_problem_domains/1-image-processing/3_edge_detectors).
